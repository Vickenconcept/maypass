        ...
        <div class=" mx-auto px-6 py-8 md:w-[50%] shadow rounded-xl bg-white mt-20">
            ...
            <form action="{{ route('roles.store') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="name" id="name" class="mt-1 p-2 block w-full border focus:outline-none focus:ring-[#b30000] focus:border-[#b30000] border-2 border-gray-200 rounded-md @error('name') border-red-500 @enderror" value="{{ old('name') }}" required placeholder="Role Name eg: staff">
                    @error('name')
