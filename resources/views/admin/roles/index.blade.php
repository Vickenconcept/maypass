                    ...
                    <div
                        ...
                        <form action="{{ route('roles.permissions.update', $role->id) }}" method="POST">
                            ...
                            <div class="flex justify-between">
                                <button type="submit"
                                    class="{{ $loop->even ? 'btn-primary' : 'btn-primary2' }}">Update
                                    Permissions</button>
                                <button data-modal-target="default-modal_{{ $role->id }}"
                                    data-modal-toggle="default-modal_{{ $role->id }}"
                                    class="block text-white bg-green-500 hover:bg-green-600 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center "
                                    type="button">
                                    Edit
                                </button>
                            </div>
