<x-guest-layout>
    <div class="flex flex-col min-h-full justify-center bg-blue-200">
        <div class="   px-6 py-8 lg:px-8 bg-[#02001a] rounded-3xl w-full md:w-[70%] lg:w-[40%] mx-auto">
            ...
            <div class=" sm:mx-auto sm:w-full sm:max-w-sm">
                ...
                <p class="mt-5 text-center text-sm text-gray-500">
                    Already registerd?
                    <a href="{{ route('login') }}"
                        class="font-semibold leading-6 text-blue-600 hover:text-blue-500">Login</a>
                </p>
            </div>
        </div>
    </div>
